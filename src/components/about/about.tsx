    ...
    <Section id="about" title="À propos" className={`${styles.about}`}>
      ...
      <div>
        <p>Etant salarié, j'ai donc fais une demande de transition professionnelle pour passer le titre professionnel Développeur Web et Web Mobile (diplôme de niveau 5 équivalent à un Bac + 2)
          à la <Link href={"https://www.wildcodeschool.com/"}>Wild Code School</Link> pour reprendre tout depuis le début et me spécialiser sur ReactJs.</p>
      </div>
      <div>
      ...
      <div>
        ...
        <p>Le Master Lead Developer Front-End à l'<Link href={"https://www.ecv.fr/digital/mastere-developpement-web/"}>ECV</Link></p>
      </div>
